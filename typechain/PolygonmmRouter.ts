...
export interface PolygonmmRouterInterface extends utils.Interface {
  functions: {
...
export interface PolygonmmRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PolygonmmRouterInterface;
