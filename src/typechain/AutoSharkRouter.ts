...
export interface AutoSharkRouterInterface extends utils.Interface {
  functions: {
...
export interface AutoSharkRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AutoSharkRouterInterface;
